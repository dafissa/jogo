...
window.onload = function() {
    ...
    dinoImg.src = "./img/dino.png"; //Define o caminho da imagem que será carregada.
    ...
    cactus2Img.src = "./img/cactus2.png"; //Essas linhas do código carregam as imagens do dinossauro e dos cactos para que possam ser desenhadas no jogo.
...
function detectCollision(a, b) { //Define se o dinossauro bateu em um cacto, analisando as coordenadas dos elementos.
    return a.x < b.x + b.width &&   //a's - O canto esquerdo do dinossauro (a.x) está antes do canto direito do cacto (b.x + b.width).
           ...
           a.y + a.height > b.y;    //a's - O canto inferior do dinossauro (a.y + a.height) passou do canto superior do cacto (b.y).
